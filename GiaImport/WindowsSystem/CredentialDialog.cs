...
namespace FtcReportControls.WindowsSystem
{
    ...
    public partial class CredentialDialog : Component
    {
        ...
        /// </summary>
        /// <value>
        /// One of the values of the <see cref="FtcReportControls.WindowsSystem.DownlevelTextMode"/> enumeration. The default value is
        /// <see cref="FtcReportControls.WindowsSystem.DownlevelTextMode.MainInstructionAndContent"/>.
        /// </value>
        /// <remarks>
        /// <para>
        ...
        public DialogResult ShowDialog(IWin32Window owner)
        {
            if( string.IsNullOrEmpty(_target) )
                throw new InvalidOperationException(ErrorStrings.CredentialEmptyTargetError);
        ...
        public void ConfirmCredentials(bool confirm)
        {
            if( _confirmTarget == null || _confirmTarget != Target )
                throw new InvalidOperationException(ErrorStrings.CredentialPromptNotCalled);
        ...
        public static void StoreCredential(string target, NetworkCredential credential)
        {
            ...
            if( target.Length == 0 )
                throw new ArgumentException(ErrorStrings.CredentialEmptyTargetError, "target");
            if( credential == null )
