...
namespace FtcReportControls.WindowsSystem
{
    ...
    public sealed class VistaFolderBrowserDialog : CommonDialog
    {
        ...
        protected override bool RunDialog(IntPtr hwndOwner)
        {
            ...
            try
            {
                dialog = new FtcReportControls.WindowsSystem.Interop.NativeFileOpenDialog();
        ...
        private void SetDialogProperties(FtcReportControls.WindowsSystem.Interop.IFileDialog dialog)
        {
            // Description
        ...
        private void GetResult(FtcReportControls.WindowsSystem.Interop.IFileDialog dialog)
        {
