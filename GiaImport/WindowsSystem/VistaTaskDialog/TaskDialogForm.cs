            ...
            set
            {
                ...
                for (int i = 0; i < Buttons.Length; i++)
                {
                    ...
                    if (i < value.Length)
                    {
                        ...
                        {
                            ((IButtonControlWithImage)button).Image = FtcReportControls.Properties.Resources.SmallSecurity;
                        }
                        else
                        {
        ...
        public string ExpandedControlText
        {
            get
            {
                if (string.IsNullOrEmpty(_expandedControlText))
                    return ResourceStrings.ExpandedText;
        ...
        public string CollapsedControlText
        {
            get
            {
                if (string.IsNullOrEmpty(_collapsedControlText))
                    return ResourceStrings.CollapsedText;
