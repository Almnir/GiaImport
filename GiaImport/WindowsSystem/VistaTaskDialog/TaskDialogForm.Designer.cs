namespace FtcReportControls.WindowsSystem.VistaTaskDialog
{
    partial class TaskDialogForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.LabelTitle = new FtcReportControls.WindowsSystem.VistaTaskDialog.Label();
            this.LabelContent = new FtcReportControls.WindowsSystem.VistaTaskDialog.Label();
            this.TableLayoutPanelContents = new System.Windows.Forms.TableLayoutPanel();
            this.LabelExpandedContent = new FtcReportControls.WindowsSystem.VistaTaskDialog.Label();
            ...
            this.LabelExpandedFooter = new FtcReportControls.WindowsSystem.VistaTaskDialog.Label();
            ...
            this.LabelFooter = new FtcReportControls.WindowsSystem.VistaTaskDialog.Label();
            ...
            //this.Button1 = new FtcReportControls.WindowsSystem.VistaTaskDialog.Button();
            //this.Button2 = new FtcReportControls.WindowsSystem.VistaTaskDialog.Button();
            //this.Button3 = new FtcReportControls.WindowsSystem.VistaTaskDialog.Button();
            //this.Button4 = new FtcReportControls.WindowsSystem.VistaTaskDialog.Button();
            //this.Button5 = new FtcReportControls.WindowsSystem.VistaTaskDialog.Button();
            //this.Button6 = new FtcReportControls.WindowsSystem.VistaTaskDialog.Button();
            //this.Button7 = new FtcReportControls.WindowsSystem.VistaTaskDialog.Button();
            //this.Button8 = new FtcReportControls.WindowsSystem.VistaTaskDialog.Button();
            //this.Button9 = new FtcReportControls.WindowsSystem.VistaTaskDialog.Button();
            //this.Button10 = new FtcReportControls.WindowsSystem.VistaTaskDialog.Button();
            //this.Button11 = new FtcReportControls.WindowsSystem.VistaTaskDialog.Button();
            this.FlowLayoutPanelButtonsLeft = new System.Windows.Forms.FlowLayoutPanel();
            this.ButtonExpander = new FtcReportControls.WindowsSystem.VistaTaskDialog.ChevronButton();
        ...
        internal FtcReportControls.WindowsSystem.VistaTaskDialog.Label LabelTitle;
        internal FtcReportControls.WindowsSystem.VistaTaskDialog.Label LabelContent;
        ...
        internal FtcReportControls.WindowsSystem.VistaTaskDialog.Label LabelFooter;
        internal FtcReportControls.WindowsSystem.VistaTaskDialog.Label LabelExpandedFooter;
        ...
        internal FtcReportControls.WindowsSystem.VistaTaskDialog.Label LabelExpandedContent;
        internal System.Windows.Forms.FlowLayoutPanel FlowLayoutPanelButtonsLeft;
        internal FtcReportControls.WindowsSystem.VistaTaskDialog.ChevronButton ButtonExpander;
