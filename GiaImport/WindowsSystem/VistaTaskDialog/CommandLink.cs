            ...
            switch (frameType)
            {
                case CommandLink.FrameType.Disabled:
                    ...
                    if (_showElevationIcon)
                        g.DrawImage(FtcReportControls.Properties.Resources.SmallSecurity, 10, 14);
                    else
                        g.DrawImage(FtcReportControls.Properties.Resources.ArrowDisabled, 8, arrowY);
                    break;
                ...
                case CommandLink.FrameType.Pressed:
                    ...
                    if (_showElevationIcon)
                        ...
                        g.DrawImage(FtcReportControls.Properties.Resources.ArrowNormal, 8, arrowY);
                    break;
                ...
                case CommandLink.FrameType.Hovered:
                    ...
                    if (_showElevationIcon)
                        ...
                        g.DrawImage(FtcReportControls.Properties.Resources.ArrowHovered, 8, arrowY);
                    break;
