...
namespace FtcReportControls.WindowsSystem
{
    ...
    public partial class TaskDialog : Component, IWin32Window
    {
        ...
        ///   with <see cref="TaskDialog.ButtonStyle"/> set to <see cref="FtcReportControls.WindowsSystem.TaskDialogButtonStyle.CommandLinks"/>
        ///   or <see cref="FtcReportControls.WindowsSystem.TaskDialogButtonStyle.CommandLinksNoIcon"/>, you delineate the command from the 
        ...
        /// </summary>
        /// <value>
        /// A <see cref="FtcReportControls.WindowsSystem.ProgressBarStyle"/> that indicates the type of progress bar shown on the task dialog.
        /// </value>
        /// <remarks>
        /// <para>
        ///   If this property is set to <see cref="FtcReportControls.WindowsSystem.ProgressBarStyle.MarqueeProgressBar"/>, the marquee will
        ///   scroll as long as the dialog is visible.
        /// </para>
        /// <para>
        ///   If this property is set to <see cref="FtcReportControls.WindowsSystem.ProgressBarStyle.ProgressBar"/>, the value of the
        ...
        /// <see cref="FtcReportControls.WindowsSystem.ProgressBarStyle.MarqueeProgressBar"/>.
        /// </remarks>
        ...
        /// <remarks>
        /// This property is only used if the <see cref="ProgressBarStyle"/> property is 
        /// <see cref="FtcReportControls.WindowsSystem.ProgressBarStyle.ProgressBar"/>.
        /// </remarks>
        ...
        /// </summary>
        /// <value>
        /// A <see cref="FtcReportControls.WindowsSystem.ProgressBarState"/> indicating the state of the task dialog's progress bar.
        /// The default value is <see cref="FtcReportControls.WindowsSystem.ProgressBarState.Normal"/>.
        /// </value>
        /// <remarks>
        /// This property is only used if the <see cref="FtcReportControls.WindowsSystem.ProgressBarStyle"/> property is 
        /// <see cref="FtcReportControls.WindowsSystem.ProgressBarStyle.ProgressBar"/>.
        /// </remarks>
        ...
        /// <summary>
        /// This method is for internal FtcReportControls.WindowsSystem use and should not be called from your code.
        /// </summary>
        ...
        {
            if( !IsDialogRunning )
                throw new InvalidOperationException(ErrorStrings.TaskDialogNotRunningError);
        ...
        private TaskDialogButton ShowDialog(IntPtr owner)
        {
            if( !OSSupportsTaskDialogs )
                throw new NotSupportedException(ErrorStrings.TaskDialogsNotSupportedError);

            if( IsDialogRunning )
                throw new InvalidOperationException(ErrorStrings.TaskDialogRunningError);

            if( _buttons.Count == 0 )
                throw new InvalidOperationException(ErrorStrings.TaskDialogNoButtonsError);
        ...
        private List<NativeMethods.TASKDIALOG_BUTTON> SetupButtons()
        {
            ...
            {
                if( button.Id < 1 )
                    throw new InvalidOperationException(ErrorStrings.InvalidTaskDialogItemIdError);
                ...
                if( button.ButtonType == ButtonType.Custom )
                {
                    if( string.IsNullOrEmpty(button.Text) )
                        throw new InvalidOperationException(ErrorStrings.TaskDialogEmptyButtonLabelError);
        ...
        private void CheckCrossThreadCall()
        {
            ...
            if( handle != IntPtr.Zero )
            {
                ...
                if( windowThreadId != threadId )
                    throw new InvalidOperationException(ErrorStrings.TaskDialogIllegalCrossThreadCallError);
            }
        }
