...
using FtcReportControls.WindowsSystem.Interop;
...
namespace FtcReportControls.WindowsSystem
{
    ...
    public abstract class VistaFileDialog : CommonDialog
    {
                    ...
                    if( value != _filter )
                    {
                        if( !string.IsNullOrEmpty(value) )
                        {
                            ...
                            if( filterElements == null || filterElements.Length % 2 != 0 )
                                throw new ArgumentException(ErrorStrings.InvalidFilterString);
        ...
        internal virtual void GetResult(FtcReportControls.WindowsSystem.Interop.IFileDialog dialog)
        {
            if( !GetOption(NativeMethods.FOS.FOS_ALLOWMULTISELECT) )
            {
                _fileNames = new string[1];
                FtcReportControls.WindowsSystem.Interop.IShellItem result;
        ...
        internal virtual void SetDialogProperties(FtcReportControls.WindowsSystem.Interop.IFileDialog dialog)
        {
            uint cookie;
            ...
            if( _showHelp )
            {
                FtcReportControls.WindowsSystem.Interop.IFileDialogCustomize customize = (FtcReportControls.WindowsSystem.Interop.IFileDialogCustomize)dialog;
                customize.AddPushButton(HelpButtonId, ErrorStrings.Help);
            }
        ...
        internal abstract FtcReportControls.WindowsSystem.Interop.IFileDialog CreateFileDialog();
        ...
        internal bool DoFileOk(FtcReportControls.WindowsSystem.Interop.IFileDialog dialog)
        {
            GetResult(dialog);
        ...
        private bool RunFileDialog(IntPtr hwndOwner)
        {
            ...
            FtcReportControls.WindowsSystem.Interop.IFileDialog dialog = null;
            try
            {
