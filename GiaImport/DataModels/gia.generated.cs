...
namespace DataModels
{
    ...
    public partial class prnf_CertificatePrintMain
    {
        ...
        /// <summary>
        /// Данные для печати свидетельства
        /// </summary>
        [Column, Nullable]
        public byte[] CertificateBlob { get; set; } // image

        /// <summary>
        /// Код АТЕ, в котором находится ОУ выпускника
        /// </summary>
        [XmlIgnore]
        [NotColumn]
        ...
        /// <summary>
        /// Код ОУ, в котором обучается выпускник
        /// </summary>
        [XmlIgnore]
        [NotColumn]
        ...
        /// <summary>
        /// Код пункта, в котором сдавал выпускник
        /// </summary>
        [Column, Nullable]
    ...
    public partial class sht_Package
    {
        ...
        [Column, Nullable]
        public string CreateTime { get; set; } // varchar(19)

        [Column, Nullable]
        public string UpdateTime { get; set; } // varchar(19)
